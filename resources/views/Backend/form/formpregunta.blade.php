    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-primary">
          <h4 class="card-title">Crear Pregunta Frecuente</h4>
          <p class="card-category">Complete todos los datos</p>
        </div>
        <div class="card-body">
          <form action="{{ route('ingresarpregunta')}}" method="POST" enctype="multipart/form-data">
 {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group bmd-form-group {{ $errors->has('pregunta') ? ' has-error' : '' }}">
                ...
                <input type="text" name="pregunta" class="form-control" required autofocus>
          ...
          <div class="row">
            ...
            <div class="form-group {{ $errors->has('respuesta') ? ' has-error' : '' }}">
              ...
              <div class="form-group bmd-form-group">
                  <textarea id="editor" name="respuesta" class="form-control" rows="4" required>&nbsp;</textarea>
          ...
          <input class="btn btn-primary pull-right" type="submit" value="Crear Pregunta">
