          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group bmd-form-group {{ $errors->has('titulo') ? ' has-error' : '' }}">
                ...
                <input type="number" step="0.01" name="monto" class="form-control" required autofocus>
                @if ($errors->has('monto'))
                    <span class="help-block">
          ...
          <div class="row">
            ...
            <div class="form-group {{ $errors->has('contenido') ? ' has-error' : '' }}">
              ...
              <div class="form-group bmd-form-group">
                  <textarea id="editor" name="descripcion_servicio" class="form-control" rows="4">&nbsp;</textarea>
          ...
          <div class="col-md-2">
            <div class="form-group bmd-form-group {{ $errors->has('seccion_id[]') ? ' has-error' : '' }}">
              ...
              <label  id="seccion_id_ch[]" class="form-check-label">
                <input id="seccion_id[]" name="seccion_id[]" value="{{$seccion->id}}"  class="form-check-input" type="checkbox">
